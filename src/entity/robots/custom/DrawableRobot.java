...
public class DrawableRobot extends Observable implements RobotModel {
	public enum Shape {
	...
	public DrawableRobot(int size, Shape shape, Color fillColor, Color borderColor, Color targetIndicatorColor, double maxVelocity, double maxAngularVelocity) {
		...
		Timer timer = new Timer("DrawableRobot timer", true);
