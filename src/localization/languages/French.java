...
public class French implements Localizer {
    ...
    public final void apply() {
        ...
        UIManager.put("ColorChooser.sampleText", "Exemple de texte Exemple de texte");
        ...
        UIManager.put("ColorChooser.swatchesRecentText", "Récent :");
        UIManager.put("ComboBox.togglePopupText", "Basculer la liste");
        UIManager.put("FileChooser.acceptAllFileFilterText", "Tous les fichiers");
        UIManager.put("FileChooser.cancelButtonMnemonic", "65");
        UIManager.put("FileChooser.cancelButtonText", "Annuler");
        UIManager.put("FileChooser.cancelButtonToolTipText", "Fermer la boîte de dialogue");
        ...
        UIManager.put("FileChooser.newFolderErrorText", "Erreur lors de la création du dossier");
        ...
        UIManager.put("OptionPane.yesButtonMnemonic", "79");
        ...
        UIManager.put("ProgressMonitor.progressText", "Processus...");
        ...
        UIManager.put("FileChooser.detailsViewButtonAccessibleName", "Tableau");
        UIManager.put("FileChooser.detailsViewButtonToolTipText", "Tableau");
        ...
        UIManager.put("FileChooser.homeFolderToolTipText", "Accueil");
        ...
        UIManager.put("FileChooser.upFolderAccessibleName", "Monter");
        UIManager.put("FileChooser.upFolderToolTipText", "Monter d’un niveau");
        UIManager.put("FileChooser.viewMenuLabelText", "Vue");
