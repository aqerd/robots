...
public class RobotCustomizationDialog extends JDialog {
    ...
    private ConfigurableRobot.Shape selectedShape = ConfigurableRobot.Shape.CIRCLE;
    private int selectedSize = 50;
    private double selectedVelocity = 1.2;
    private double selectedAngularVelocity = 0.01;

    private boolean confirmed = false;
    private Map<String, ConfigurableRobot.Shape> shapeNameMap;

    public RobotCustomizationDialog(Frame owner) {
        ...
        for (ConfigurableRobot.Shape shape : ConfigurableRobot.Shape.values()) {
    ...
    public ConfigurableRobot.Shape getSelectedShape() {
